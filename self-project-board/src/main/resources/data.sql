...
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at,
                          modified_by)
values ('sspark', 'asdf1234', 'Sspark', 'sspark@mail.com', 'I am Sspark.', now(), 'sspark', now(), 'sspark')
;
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at,
                          modified_by)
values ('sspark2', 'asdf1234', 'Sspark2', 'sspark2@mail.com', 'I am Sspark2.', now(), 'sspark2', now(), 'sspark2')
;
