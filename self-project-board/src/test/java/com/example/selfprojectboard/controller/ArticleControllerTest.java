...
import com.example.selfprojectboard.config.SecurityConfig;
import com.example.selfprojectboard.config.TestSecurityConfig;
...
import com.example.selfprojectboard.service.ArticleService;
import com.example.selfprojectboard.service.PaginationService;
import com.example.selfprojectboard.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @DisplayName("[view][GET] 게시글 페이지 - 인증 없을 땐 로그인 페이질 이동")
    @Test
    void givenNothing_whenRequesetingArticlePage_thenRedirectsToLoginPage() throws Exception{
        //Given
        long articleId = 1L;
        //When & Then
        mvc.perform(
...
//                .andExpect(model().attributeExists("paginationBarNumbers"));
    ...
    @WithUserDetails(value="ssparkTest", /*userDetailsServiceBeanName = "userDetailsService", */setupBefore = TestExecutionEvent.TEST_EXECUTION) //설정한 UserDetails를 사용할 수 있다. 단 DB에도 데이터가 존재해야함
    ...
    @WithUserDetails(value="ssparkTest",setupBefore = TestExecutionEvent.TEST_EXECUTION)
