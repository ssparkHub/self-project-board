...
public class DataRestTest {
    ...
    @Test
    void giveNothing_whenRequestingArticles_thenReturnsArticleCommentsJsonResponse() throws Exception {
    ...
    @Test
    void giveNothing_whenRequestingArticles_thenReturnsArticleCommentJsonResponse() throws Exception {
